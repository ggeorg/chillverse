...
//@formatter:off
  ...
  boolean ga_client_start(Avahi self, GError error);
//@formatter:on
...
//@formatter:off
  ...
  boolean ga_record_browser_attach(RecordBrowser self, Avahi client, GError error);
//@formatter:on
...
//@formatter:off
  ...
  boolean ga_service_browser_attach(ServiceBrowser self, Avahi client, GError error);
//@formatter:on
...
//@formatter:off
  ...
  boolean ga_service_resolver_attach(ServiceResolver self, Avahi client, GError error);
  boolean ga_service_resolver_get_address(ServiceResolver self, Address address, short[] port);
//@formatter:on

//@formatter:off
  Pointer ga_entry_group_new();
  boolean ga_entry_group_attach(EntryGroup self, Avahi client, GError error);
  EntryGroupService ga_entry_group_add_service(EntryGroup self, String name, String type, short port, GError error, String ... txt);
  EntryGroupService ga_entry_group_add_service_full(EntryGroup self, int iface, int protocol, int flags, String name, String type, String domain, String host, short port, GError error, String ... txt);
